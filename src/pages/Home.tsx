    ...
    <>
      <div className="container mx-auto p-6 bg-white shadow-md rounded-lg">
        ...
        <p className="text-lg text-gray-700 leading-relaxed mb-6">
          ...
          africanas y europeas. Los platos típicos incluyen mariscos frescos,
          caracoles, cangrejos, y el famoso Rondón, un guiso de pescado y
          mariscos con leche de coco y tubérculos. También se destacan el pan de
          coco y el patí, una empanada rellena de carne especiada. Cada plato
        ...
        <p className="text-lg text-gray-700 leading-relaxed mb-6">
          ...
          exótico que se disfruta en diversas preparaciones, desde sopas hasta
        ...
        <p className="text-lg text-gray-700 leading-relaxed mb-6">
          ...
          sustancioso que refleja la abundancia de la región. El pan de coco,
          con su textura suave y sabor dulce, es perfecto para acompañar
